...
pub type OwnedEchoRequestView = ::buffa::view::OwnedView<
    crate::buffa::api::v1::__buffa::view::EchoRequestView<'static>,
>;
///Shorthand for `OwnedView<EchoResponseView<'static>>`.
pub type OwnedEchoResponseView = ::buffa::view::OwnedView<
    crate::buffa::api::v1::__buffa::view::EchoResponseView<'static>,
>;
impl ::connectrpc::Encodable<crate::buffa::api::v1::EchoResponse>
for crate::buffa::api::v1::__buffa::view::EchoResponseView<'_> {
    fn encode(
        &self,
...
pub const ECHO_SERVICE_SERVICE_NAME: &str = "api.v1.EchoService";
...
pub const ECHO_SERVICE_ECHO_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/api.v1.EchoService/Echo",
        ::connectrpc::StreamType::Unary,
    )
    .with_idempotency_level(::connectrpc::IdempotencyLevel::Unknown);
/// EchoService echoes a message back to the caller.
///
...
pub trait EchoService: Send + Sync + 'static {
    ...
    fn echo<'a>(
        ...
        request: ::connectrpc::ServiceRequest<'_, crate::buffa::api::v1::EchoRequest>,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                crate::buffa::api::v1::EchoResponse,
            > + Send + use<'a, Self>,
        >,
    > + Send;
}
                ...
                "Echo",
                {
                    ...
                    ::connectrpc::view_handler_fn(move |
                        ...
                        req: ::buffa::view::OwnedView<
                            crate::buffa::api::v1::__buffa::view::EchoRequestView<
                                'static,
                            >,
                        >,
                        format|
                    {
                        ...
                        async move {
                            let sreq = ::connectrpc::ServiceRequest::<
                                crate::buffa::api::v1::EchoRequest,
                            >::from_parts(req.reborrow(), req.bytes());
                            svc.echo(ctx, sreq)
                                .await?
                                .encode::<crate::buffa::api::v1::EchoResponse>(format)
                        }
                    })
                },
            )
...
impl<T: EchoService> ::connectrpc::Dispatcher for EchoServiceServer<T> {
    ...
    fn lookup(
        ...
        let method = path.strip_prefix("api.v1.EchoService/")?;
        match method {
            "Echo" => {
                Some(
    ...
    fn call_unary(
        ...
        let Some(method) = path.strip_prefix("api.v1.EchoService/") else {
        ...
        match method {
            "Echo" => {
                ...
                Box::pin(async move {
                    ...
                    let req: crate::buffa::api::v1::__buffa::view::EchoRequestView<'_> = ::connectrpc::dispatcher::codegen::decode_borrowed_request_view(
                        &body,
                    )?;
    ...
    <T::ResponseBody as ::connectrpc::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the Echo RPC. Sends a request to /api.v1.EchoService/Echo.
    pub async fn echo(
        &self,
        request: crate::buffa::api::v1::EchoRequest,
    ) -> Result<
