...
class GoFeatures(_message.Message):
    ...
    def __init__(self, legacy_unmarshal_json_enum: _Optional[bool] = ..., api_level: _Optional[_Union[GoFeatures.APILevel, str]] = ..., strip_enum_prefix: _Optional[_Union[GoFeatures.StripEnumPrefix, str]] = ...) -> None: ...
